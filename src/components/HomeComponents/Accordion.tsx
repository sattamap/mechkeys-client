  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-center gap-8 bg-slate-200 rounded-xl p-10 m-8 md:m-16">
      <div className="text-center md:text-left">
        <p className='text-4xl font-bold text-gray-900'>Have a question? <br />We are here to help.</p>
        <p className='text-base font-medium text-gray-700 mt-4'>Check out the full FAQ page or reach out to our customer support team.</p>
      ...
      <div className='bg-white p-6 md:p-10 rounded-xl w-full md:max-w-2xl shadow-lg'>
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            <AccordionTrigger className="text-gray-900">Why Choose Mechanical Keyboards?</AccordionTrigger>
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger className="text-gray-900">What are the different types of switches?</AccordionTrigger>
            <AccordionContent className="text-gray-700">
          ...
          <AccordionItem value="item-3">
            <AccordionTrigger className="text-gray-900">How can I customize my mechanical keyboard?</AccordionTrigger>
            <AccordionContent className="text-gray-700">
          ...
          <AccordionItem value="item-4">
            <AccordionTrigger className="text-gray-900">Are mechanical keyboards more durable?</AccordionTrigger>
            <AccordionContent className="text-gray-700">
